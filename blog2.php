...
<head>
<meta charset="utf-8">
<title>Modern-Link Technologies</title>
<!-- Stylesheets -->
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="text">Pleasure and praising pain was born
                                        give a complete your account ...</div>
                                    <div class="link">
                ...
                <aside class="col-lg-3 sidebar">
                    <div class="blog-sidebar">
                        ...
                        <div class="widget widget_categories">
                            ...
                            <div class="widget-content">
                                <ul class="categories-list clearfix">
                                    ...
                                    <li><a href="#">Website Management <i class="flaticon-right-arrow-6"></i> <span>[08]</span></a></li>
                                    <li><a href="#">Industry News <i class="flaticon-right-arrow-6"></i> <span>[07]</span></a></li>
                                    <li><a href="#">Database Management <i class="flaticon-right-arrow-6"></i> <span>[14]</span></a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="wrapper-box">
                                ...
                                <div class="post" style="background-image: url(assets/images/resource/news-26.jpg);">
                                    <div class="content">
                                        ...
                                        <h4><a href="blog-details.html">Conditions for Applying C / O  for  Modern-Link Website Designing</a></h4>
                                    </div>
                                </div>
                                <div class="post" style="background-image: url(assets/images/resource/news-26.jpg);">
                                    <div class="content">
                                        <div class="date"><i class="far fa-calendar"></i> 10 May 2020</div>
                                        <h4><a href="blog-details.html">Introduce new technology service in this spring</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget advertisement-widget">
                            <div class="content">
                                <div class="logo"><a href="index.html"><img src="assets/images/logo.png" alt=""></a></div>
                                <h4>We Offering <br> Best & Reliable <br> Services.</h4>
                                <div class="link-box">

            ...
            <div class="content-wrapper">
                ...
                <div class="contact-widget">
                    <div class="icon-box">
                        ...
                        <div class="text">Harare CBD, <br> Zimbabwe.</div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-calling"></span></div>
                        <div class="text"><strong>Phone</strong><a href="tel:+263 715 725 572">+263 715 725 572</a></div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-mail"></span></div>
                        <div class="text"><strong>Email</strong><a href="tel:+263 715 725 572">info@modernlink.com</a></div>
                    </div>
                </div>
                <!-- Link Btn -->

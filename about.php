...
<?php include "header.php"; ?>
    ...
    <!-- Page Title -->
    <section class="page-title" style="background-image: url(assets/images/background/modern-3.jpg);">
        ...
        <div class="auto-container">
            <div class="content-box">
                <div class="content-wrapper">
                   ...
                   <ul class="bread-crumb style-two"><br><br>
    ...
    <section class="who-we-are-section">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="sec-title mb-30">
                            ...
                            <h2>We're <br> Partner of <br> Your Innovations</h2>
                        </div>
                        <div class="experience-year">
                            <div class="icon"><i class="flaticon-package-1"></i></div>
                            <div class="content">
                                <h3>02 <span>+ Years</span></h3>
                                <h5>Experience In Website Designing</h5>
                            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="image mb-30"><img src="assets/images/resource/modern-3.jpg" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="overview">
            <div class="auto-container">
                <div class="wrapper-box">
                    <h2>Modern-Link Technologies has been operating in Zimbabwe now, for over 2 years and are part <br>  of a Reliable<br><span class="elementor-icon-list-text">Best quality support</span><br> <span class="elementor-icon-list-text">Serve the best</span><br> <span class="elementor-icon-list-text">Trusted Professionals</span></h2>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="text">
                                <p>Modern-Link is a provider of IT consulting and software development services. We have helped organizations and companies improve business performance & enhance their competitiveness...</p>
                                <p>Modern-Link Technologies has been the premiere agency to assist corporations with their website build_up, management, and Database management. Alongside our highly qualified workforce, we believe our track record and amassed relationships not only from our current clientele base, we have a growing network all over, but also our experience as owned by the Zimbabwean could be beneficial to any business with interest to expand.</p>
                            </div>
                            <div class="author-info wow fadeInUp" data-wow-duration="1500ms">
                                ...
                                <div class="signature"><img src="assets/images/sign1.PNG" alt=""></div>
                                <div>
                                    <div class="author-title">Godknows Aresho </div>
                                    <div class="designation">Director & Founder of Modern-Link Technologies </div>
                                </div>
                                <div class="signature"><img src="assets/images/sign1.PNG" alt=""></div>
                                <div>
                                    <div class="author-title">Prosper Makoni </div>
                                    <div class="designation">Director & Founder of Modern-Link Technologies </div>
                                </div>
                                <div class="signature"><img src="assets/images/sign1.PNG" alt=""></div>
                                <div>
                                    <div class="author-title">Farirai J Masocha </div>
                                    <div class="designation">Director & Founder of Modern-Link Technologies </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="whychooseus-section-four" style="background-image: url(assets/images/background/modern-3.jpg);">
        <div class="auto-container">
            <div class="sec-title light text-center">
                <div class="sub-title">Why Choose Us</div>
                <h2> Reasons Why to Choose Our <br> Website Design Services</h2>
            </div>
            <div class="row">
                        ...
                        <div class="tab-content wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                            ...
                            <div class="tab-pane fadeInUp animated" id="tab-two" role="tabpanel" aria-labelledby="tab-two">
                                <div class="text-block">
                                    ...
                                    <div class="text">To be globally-recognized Website Developers company that leads by global sector and providing a harmonious and motivating workplace that will attract, develop, and keep the right people.</div>
                                </div>
                            </div>

...
<head>
<meta charset="utf-8">
<title><?php echo $setting['site_name']; ?> - Developers</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="contact-widget">
                    <div class="icon-box">
                        ...
                        <div class="text">Harare City Road, <br> Harare, Zimbabwe.</div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-calling"></span></div>
                        <div class="text"><strong>Phone</strong><a href="tel:(+61)3245689790">Coming Soon</a></div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-mail"></span></div>
                        <div class="text"><strong>Email</strong><a href="tel:(+61)32456789790">info@modernlink.com</a></div>
                    </div>
                </div>
                <!-- Link Btn -->
    ...
    <section class="banner-section">
        ...
        <div class="swiper-container banner-slider">
            <div class="swiper-wrapper">
                <!-- Slide Item -->
                <div class="swiper-slide" style="background-image: url(assets/images/main-slider/zim.jpg);">
                    <div class="content-outer">
                        <div class="content-box">
                            <div class="inner text-center">
                                <h4>EXPERIENCE THE BEST IT SOLUTIONS </h4>
                                <h1>IT SOLUTIONS & SERVICES</h1>
                                <div class="text">Best Leading Website Designer's And Management In Town!!!</div>
                                <div class="link-box">
                ...
                <!-- Slide Item -->
                <div class="swiper-slide" style="background-image: url(assets/images/main-slider/modern-4.jpg);">
                    <div class="content-outer">
                        <div class="content-box">
                            <div class="inner text-center">
                                <h4>We're Partner Of Website Development </h4>
                                <h1>Perfect solutions that business demands</h1>
                                <div class="text">We eagerly put in use new IT innovations.</div>
                                <div class="link-box">
                                    <a href="#" class="theme-btn btn-style-one"><span><i class="flaticon-up-arrow"></i>More Details </span></a>
                                </div>
                            </div>                               
                ...
                <!-- Slide Item -->
                <div class="swiper-slide" style="background-image: url(assets/images/main-slider/modern-7.jpg);">
                    <div class="content-outer">
                        <div class="content-box">
                            <div class="inner text-center">
                                <h4>It’s possible here</h4>
                                <h1>Website design work delivered on time</h1>
    ...
    <!-- serivice from here -->
        ...
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <h2>Building Website Design Products Across <br> All Borders</h2>
            </div>
...
.zoom:hover {
  transform: scale(1.02); /* (150% zoom - Note: if the zoom is too large, it will go outside of the viewport) */
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="sec-title">
                        ...
                        <div class="text">We Offer Website Creation to all businesses in selling and advertising their products across the globe. We connect domestic companies to the international companies services most suited for their business. </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="icon-box wow fadeInUp" data-wow-duration="1500ms">
                                ...
                                <div class="content">
                                    <span><h4>Website Design and Mobile Applications</h4></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="icon-box wow fadeInUp" data-wow-duration="1900ms">
                                ...
                                <div class="content">
                                    <span><h4>We Build Websites On Time</h4></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="image wow fadeInRight" data-wow-duration="1500ms"><img src="assets/images/resource/link-1.jpg" alt=""></div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 why-choose-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        ...
                        <div class="content">
                            <h4>Perfect Website Checking</h4>
    ...
    <section class="work-process-section">
        <div class="bg" style="background-image: url(assets/images/background/model-1.jpg);"></div>
        <div class="auto-container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 work-process-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        ...
                        <h4>Website Development <br> & Operational</h4>
                ...
                <div class="col-lg-3 col-md-6 work-process-block">
                    <div class="inner-box wow fadeInDwon" data-wow-duration="1500ms">
                        ...
                        <h4>Platform Integration <br> Operation</h4>
                ...
                <div class="col-lg-3 col-md-6 work-process-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        ...
                        <h4>Smart Marketing <br> & Distribution</h4>
                ...
                <div class="col-lg-3 col-md-6 work-process-block">
                    <div class="inner-box wow fadeInDown" data-wow-duration="1500ms">
                        ...
                        <h4>Hosting <br> Site</h4>
                        
                    </div>
                </div>
            </div>
            <div class="bottom-text">Save Time and Money with a Top IT Solution Agency <a href="contact.php"> Get In Touch</a></div>
        </div>
    </section>
...
<!-- Pricing Section -->
        ...
        <div class="auto-container">
            ...
            <div class="row m-0">
                <div class="col-lg-4 col-md-6 pricing-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        <div class="category-wrapper"><div class="category">Static Website</div></div>
                        <div class="price">$4.99</div>
                        <div class="time">Per Page</div>
                        <ul class="content">
                            <li>Without Database </li>
                            <li>Fully Functional</li>
                            <li>Delivery on Time</li>
                            <li>100% Customer centric</li>
                            <li>High perfoming</li>
                        </ul>
                        <div class="link-box">
                ...
                <div class="col-lg-4 col-md-6 pricing-block style-two">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" style="background-image: url(assets/images/model.jpg);">
                        <div class="category-wrapper"><div class="category">Dynamic Website</div></div>
                        <div class="price">From $49.99</div>
                        <div class="time">Per website</div>
                        <ul class="content">
                            <li>With Database </li>
                            <li>User-Friendly</li>
                            <li>Fully Functional</li>
                ...
                <div class="col-lg-4 col-md-6 pricing-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        <div class="category-wrapper"><div class="category">With Articial Intelligence</div></div>
                        <div class="price">$299.99</div>
                        <div class="time">Per website</div>
                        <ul class="content">
                           <li>With Database </li>
                           <li>With Artifial intelligence</li>
                            <li>User-Friendly</li>
                            <li>Fully Functional</li>
                            <li>Delivery on Time</li>
                            <li>100% Customer centric</li>
    ...
    <section class="facts-section">
        <div class="auto-container">
            <div class="wrapper-box" style="background-image: url(assets/images/background/model.jpg);">
                <div class="shape">
                        ...
                        <div class="column counter-column col-md-6">
                            <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="content">
                                    ...
                                    <div class="text">Sucessfully  Created</div>
                                </div>
                            </div>
                        </div>
                        <!--Column-->
                        <div class="column counter-column col-md-6">
                            <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="content">
                                    ...
                                    <div class="count-outer count-box">
                                        <span class="count-text" data-speed="30" data-stop="5">0</span>
                                    </div>
                        ...
                        <div class="column counter-column col-md-6">
                            <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="content">
                                    ...
                                    <div class="count-outer count-box">
                                        <span class="count-text" data-speed="30" data-stop="20">0</span>
                                    </div>
                        ...
                        <div class="column counter-column col-md-6">
                            <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="content">
                                    <div class="icon"><img src="assets/images/icons/icon-3.png" alt=""></div>
                                    <div class="count-outer count-box">
                                        <span class="count-text" data-speed="30" data-stop="3">0</span>
                                    </div>
                        ...
                        <div class="column counter-column col-md-6">
                            <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="content">
                                    <div class="icon"><img src="assets/images/icons/icon-3.png" alt=""></div>
                                    <div class="count-outer count-box">
                                        <span class="count-text" data-speed="30" data-stop="25">0</span>
                                    </div>
                                    <div class="text">Lot of Websites</div>
                                </div>
                            </div>
                        </div>
                    </div>

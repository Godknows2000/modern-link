                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="icon-box">
                                            <div class="icon"><span class="flaticon-mail"></span></div>
                                            <div class="text-area">
                                                <div class="text"><strong>Mon - Friday</strong>08.00 am to 1730Hrs</div>
                        ...
                        <div class="col-lg-6">
                            <div class="sec-title">
                                ...
                                <h2>Order Your Website Build-Up With Us Today </h2>
                            </div>
    ...
    <section class="contact-form-section" id="cform">
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <div class="text">Please do not hesitate to contact us if you require further information about our website designing service.</div>
            </div>
            <!--Contact Form-->

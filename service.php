    ...
    <!-- serivice from here -->
        ...
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <h2>Creating websites acrross <br> All Borders</h2>
            </div>
    ...
    <div class="container pb-5">
        <div class="row">
            <div class="col-md-12 text-center">
                <p><b>we are one stop company to fulfill your sourcing of all your required IT solutions as we produce websites and databases along with mobile applications</b></p>
                <p>We give complete A to Z solution starting from Static to Dynamic. We specialize also in making sure the website is hosted online.</p>
            </div>
        </div>
    </div>
    ...
    <section class="services-section-two style-two mx-30">
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <h2>Modern-Link Technologies Offers Various Value Added <br>Services in Website Design and Development</h2>
            </div>
            <div class="row">
                <div class="col-xl-6 service-block-two">
                    <div class="inner-box">
                        <div class="image-box">
                            <img src="assets/images/resource/hosting.jpg" alt="">
                            <div class="icon"><span class="flaticon-hosting"></span></div>
                        </div>
                        <div class="content">
                            <h4>Website Hosting</h4>
                            <div class="text">Our web experiences are high-perfoming, feature packed and digital transformative and designed to be user-friendly, <br> making enterprise grow ...</div>
                            <!--<div class="link">
                ...
                <div class="col-xl-6 service-block-two">
                    <div class="inner-box">
                        <div class="image-box">
                            <img src="assets/images/resource/development.jpg" alt="">
                            <div class="icon"><span class="flaticon-development"></span></div>
                        </div>
                        <div class="content">
                            <h4>Website Development</h4>
                            <div class="text">We are client focused, customer centric, creating digital solutions that deliver<br>tangible business results ...</div>
                            <!--<div class="link">
                                <a href="#" class="readmore-link"><span><i class="flaticon-up-arrow"></i>Read More</span></a>
                            </div>-->
                        </div>

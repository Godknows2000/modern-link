...
<div class="page-wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="contact-widget">
                    <div class="icon-box">
                        ...
                        <div class="text">Harare CBD, <br> Harare, Zimbabwe.</div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-calling"></span></div>
                        <div class="text"><strong>Phone</strong><a href="tel:(+263)715725572">(+263) 725 725 572</a></div>
                    </div>
                    <div class="icon-box">
                        <div class="icon"><span class="flaticon-mail"></span></div>
                        <div class="text"><strong>Email</strong><a href="tel:(+263)715725572">info@modernlink.com</a></div>
                    </div>
                </div>
                <!-- Link Btn -->
    ...
    <br><br><h5 class=" text-left"><b>1. Copyright and Trademark Information</b></h5>
                ...
                <p class="text-left">This website (this "Website"), and the information which it contains, such as text, graphics, images, data, reports, links, information obtained from Modern-Link Technologies licensors, services and other material and Deliverables (as defined below) contained on this Website or provided through Services (as defined below) made available on the Website (collectively, "Content") are the property of Global Worldwide Solution, its affiliates and its licensors, and are protected from unauthorized copying and dissemination by Zimbabwe copyright law, trademark law, international conventions and other intellectual property laws. By way of example only, and not as a limitation, "Global Worldwide Solution" and the Modern-Link Technologies logo are registered trademarks of Modern-Link Technologies, Inc., under the applicable laws of the Zimbabwe and/or other countries. Other Global Worldwide Solution product or service names or logos appearing on this Website are either trademarks or registered trademarks of Modern-Link Technologies, Inc. and/or its affiliates. The absence of a product or service name or logo from this list does not constitute a waiver of Modern-Link Technologies trademark or other intellectual property rights concerning that name or logo.</p>
            ...
            <h5 class=" text-left"><b>5. Limitation and Disclaiming of Liability</b></h5>
                <p class="text-left">ALL CONTENT PROVIDED ON THIS SITE IS PROVIDED "AS IS." SPECIFICALLY, BUT WITHOUT LIMITATION, Modern-Link Technologies DOES NOT WARRANT THAT: (i) THE INFORMATION ON THIS SITE, WHETHER CONTRIBUTED BY Modern-Link Technologies OR A THIRD PARTY, IS CORRECT, ACCURATE, RELIABLE OR COMPLETE; (ii) THE FUNCTIONS CONTAINED ON THIS SITE WILL BE UNINTERRUPTED OR ERROR-FREE; (iii) DEFECTS WILL BE CORRECTED, OR (iv) THIS SITE OR THE SERVER(S) THAT MAKES IT AVAILABLE ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS.</p>
                <p class="text-left">UNDER NO CIRCUMSTANCES SHALL Modern-Link Technologies BE LIABLE FOR ANY INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES, OR FOR DAMAGES FOR LOSS OF PROFITS, LOSS OF DATA, LOSS OF USE OR COSTS OF OBTAINING SUBSTITUTE GOODS OR SERVICES, ARISING OUT OR RELATING TO THE USE OF, OR THE INABILITY TO USE, THIS WEBSITE, THE SERVICES OR THE INFORMATION CONTAINED ON THIS SITE, WHETHER BASED UPON WARRANTY, CONTRACT, TORT OR OTHERWISE, EVEN IF Modern-Link Technologies HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</p>
                <p class="text-left">IN NO EVENT SHALL Modern-Link Technologie'S TOTAL LIABILITY TO YOU FOR ALL DAMAGES, LOSSES AND CAUSES OF ACTION RESULTING FROM YOUR USE OF THIS SITE INCLUDING THE USE OF ANY SERVICES, WHETHER IN CONTRACT, TORT OR OTHERWISE, EXCEED, IN THE AGGREGATE, THE GREATER OF (A) AMOUNTS PAID BY YOU TO Global Worldwide Solution FOR THE SERVICES IN THE TWELVE (12) MONTHS IMMEDIATELY PRECEDING THE APPLICABLE CLAIM; OR (B) ONE U.S. DOLLAR ($1). THIS LIMITATION IS CUMULATIVE AND NOT PER CLAIM.</p>
            <h5 class=" text-left"><b>6. Your Submissions</b></h5>
                <p class="text-left">You may choose to display, upload, submit, transmit or publish on or through this Website ("post") text, graphics, images, videos, sounds, data, reports, links, information, suggestions, improvements, works of authorship or any other materials to Modern-Link Technologies or any other user of the Website via the communications platform included on the Website, as it may be available from time to time (collectively, "Submissions").</p>
                <p class="text-left">By posting Submissions, You hereby grant to Modern-Link Technologies and its affiliates a non-exclusive, fully-paid, irrevocable, royalty-free, perpetual, worldwide license to use, modify, publicly perform, publicly display, reproduce and distribute such Submissions on and through this Website or other sites owned by Modern-Link Technologies or its affiliates or to incorporate such Submissions into any other products or services of GModern-Link Technologies or its affiliates. Modern-Link Technologies shall have a non-exclusive, fully-paid, irrevocable, royalty-free, perpetual, worldwide license to use or incorporate any suggestions, ideas, enhancement requests, feedback, recommendations or other information You provide relating to this Website, the services available through this Website and/or any Content</p>
                <p class="text-left">You further grant Modern-Link Technologies and its affiliates a non-exclusive, fully-paid, irrevocable, royalty-free, perpetual, worldwide license to use the profile information You provide to Global Worldwide Solution, and all other information regarding Your use of the Website, the Content and the Services for any lawful purpose, including without limitation, for marketing and advertising purposes.</p>
            ...
            <h5 class=" text-left"><b>7. Standards of User Conduct</b></h5>
                ...
                <p class="text-left">Modern-Link Technologies reserves the right, without prior notice and in its sole discretion, to decide whether Submissions violate these terms and conditions for any of the above reasons or for any other reason, and if Modern-Link Technologies does so, to remove such Submissions which You post to the Website and/or terminate Your access to any restricted access Services of Modern-Link Technologies.</p>
            <h5 class=" text-left"><b>8. Links to Third-Party Web Sites</b></h5>
                <p class="text-left">This Website may contain links to non-Modern-Link Technologies web sites. These links are provided to You as a convenience, and Modern-Link Technologies is not responsible for the content of any linked web site. Any non-Modern-Link Technologies web site accessed from this Website is independent from Modern-Link Technologies, and Modern-Link Technologies has no control over the content of that web site. In addition, a link to any non-Modern-Link Technologies web site does not imply that Modern-Link Technologies endorses or accepts any responsibility for the content or use of such web site.</p>
            <h5 class=" text-left"><b>9. No Third-Party Approvals or Implied Endorsements</b></h5>
                <p class="text-left">Any third party which is the subject of profiles, reports or other information, provided by Modern-Link Technologies through this website or otherwise, likely has not approved or sponsored Modern-Link Technologie's provision of such information.  Further, in no event shall any reference to any third party or third party product or service be construed as an approval or endorsement by Modern-Link Technologies of that third party or of any product or service provided by a third party.</p>
            <h5 class=" text-left"><b>10. Notice and Take Down Procedures; Copyright Agent</b></h5>
                <p class="text-left">If You believe any materials accessible on or from this Website infringe Your copyright, You may request removal of those materials (or access thereto) from this Website by contacting Modern-Link Technologie’s copyright agent (identified below) and providing the following information:</p>
            ...
            <h5 class=" text-left"><b>11. Indemnity</b></h5>    
                <p class="text-left">You agree to indemnify, defend and hold harmless Modern-Link Technologies, its affiliates, officers, directors, employees, consultants, agents, representatives, licensors, and suppliers, from any and all claims, losses, liability, damages and/or costs (including reasonable attorneys’ fees and costs) arising out of or relating to (1) Your use of the Website, Services and/or Content; (2) Your violation of these Terms and Conditions, including without limitation any representations and warranties hereunder and any agreements incorporated by reference; and/or (3) Your infringement, or infringement by any other user of Your account(s), of any intellectual property or other right of any person or entity.</p>
            <h5 class=" text-left"><b>12. Export and Sanctions Compliance</b></h5> 
                <p class="text-left">The laws of the Zimbabwe prohibit the export of certain software and data to particular persons, territories and foreign states. You agree not to export, reexport, resell, or transfer any Modern-Link Technologies data or services in any manner that will violate any laws. Without limiting the foregoing, You agree that You are not a Restricted Party; that You will not export, reexport, resell, or transfer any Modern-Link Technologies data or services to any person or entity that is a Restricted Party; that You will implement and maintain reasonable and appropriate procedures for preventing unauthorized access to Modern-Link Technologies data or services; and that You will notify Global Worldwide Solution immediately upon learning that You or a user of the Modern-Link Technologies data or services provided to You under this Agreement becomes a Restricted Party.</p>
                <p class="text-left">For purposes of this Section 12, a “Restricted Party” is any person or entity that is (1) located or established in, organized under the laws of, or controlled by the government or by one or more nationals of South Africa, Botswana, Zambia, Tanzania,Mozambique or any other country that may, from time to time, become subject to Zimbabwe. export controls for anti-terrorism reasons or designated as a country that is subject to a general prohibition on Zimbabwe. persons’ engaging in financial and/or export transactions; (2) on the Zimbabwe. Department of Commerce Denied Persons List, Entity List, or Unverified List; Zimbabwe. Department of the Treasury list of Specially Designated Nationals and Blocked Persons; or Zimbabwe. Department of State List of Debarred Parties; (3) part of, affiliated with, or controlled by or acting on behalf of any non-Zimbabwe. military organization; or (4) engaged in end use activities that are subject to restriction under Zimbabwe. export laws, including without limitation nuclear, missile, or chemical or biological weapon-related activities.</p>
            <h5 class=" text-left"><b>13. Anti-corruption Laws; Foreign Corrupt Practices Act</b></h5> 
                <p class="text-left">a) You represent, warrant and covenant to Modern-Link Technologies that You have not and will not, in connection with the data or services provided under this Agreement, make, promise or offer to make any payment or transfer of anything of value, directly or indirectly: (i) to any Government Official, or to any other person or entity, if such payment or transfer is intended to induce any official action by such Government Official; to obtain, retain or direct business to any person; to secure an improper advantage; or otherwise violate the Foreign Corrupt Practices Act any other law applicable to You.</p>
            ...
            <h5 class=" text-left"><b>14. Enforcement of Terms and Conditions</b></h5>
                <p class="text-left">These Terms and Conditions are governed and interpreted pursuant to the laws of the Republic of Zimbabwe, without reference to its conflicts of law principles, to the extent such principles would apply the law of any other jurisdiction.</p>
                <p class="text-left">All disputes arising out of or relating to these Terms and Conditions shall be finally resolved by arbitration before a single arbitrator conducted in the English language in Republic of Zimbabwe. under the Commercial Arbitration Rules of the American Arbitration Association. The parties shall appoint as sole arbitrator a retired judge who presided in the State of Zimbabwe. The parties shall bear equally the cost of the arbitration (except that the prevailing party shall be entitled to an award of reasonable attorneys' fees incurred in connection with the arbitration in such an amount as may be determined by the arbitrator). All decisions of the arbitrator shall be final and binding on both parties and enforceable in any court of competent jurisdiction. Notwithstanding this, application may be made to any court for a judicial acceptance of the award or order of enforcement. Notwithstanding the foregoing, Modern-Link Technologies shall be entitled to seek injunctive relief, security or other equitable remedies from the United States District Court for the Southern District of New York or any other court of competent jurisdiction.</p>
                ...
                <p class="text-left">Modern-Link Technologies may, at its sole discretion and without notice, revise these terms at any time by updating this posting.</p>
            <h5 class=" text-left"><b>15. Other Terms</b></h5>
                ...
                <p class="text-left">Modern-Link Technologies retains ownership of all intellectual property rights to its Content, technology, software, documentation and tools used in connection with the Website, Services, and/or Content.</p>
